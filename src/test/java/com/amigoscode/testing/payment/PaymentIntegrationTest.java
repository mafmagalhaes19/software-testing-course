...
//Makes sure that whenever we run any test within this class, the application will start
@SpringBootTest
...
class PaymentIntegrationTest {
    ...
    void itShouldCreatePaymentSuccessfully() throws Exception {
        ...
        Customer customer = new Customer(customerId, "James", "+351911234567");
        ...
        //Payment request
        long paymentId = 1L;
        Payment payment = new Payment(paymentId, customerId, new BigDecimal("100.00"), Currency.GBP, "x0x0x0", "Zakat");
